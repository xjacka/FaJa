...
enum Instruction {
	...
	INIT_NUM(7,2),      // create number object without constructor
	INIT_STRING(8, 2),  // create string object without constructor
	INIT_BOOL(9, 2),    // create bool object without constructor
